...
public partial class BotCore
{
    ...
    public Embed GetStartupMessageEmbed()
    {
        return new EmbedInstance()
        {
            ...
            Color = ACCENT_COLOR,
            Fields = [
                new("Actions", $"Registered actions: {_actionManager.RegisteredActions.Count}"),
                new("Variables", $"Registered variables: {_variableManager.RegisteredVariables.Count}"),
                new("Filters", $"Registered filters: {_filterManager.RegisteredFilters.Count}"),
                new("Events", $"Registered events: {_eventManager.RegisteredEvents.Count}"),
